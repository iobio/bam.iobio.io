...
class Bam  {
   ...
   _mapToBedCoordinates(regions, bed) {
   ...
   _referenceMatchesBed(ref, bedRef) {
      if (ref == bedRef) {
        return true;
      }
   ...
   getReferencesWithReads(callback) {
      var refs = [];
      var me = this;
      if (this.sourceType == 'url') {
